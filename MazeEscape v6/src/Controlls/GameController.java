...
public class GameController {
    ...
    public void runSimulation() {
        ...
        while (!allAgentsReachedGoal() && turnCount < maxTurns) {
            ...
            String action = new java.util.Scanner(System.in).nextLine().trim().toUpperCase();
    ...
    private void printSummaryStatistics() {
        ...
        log.append("\nPer-Agent Statistics:\n");
        System.out.println("Agent | Moves | Backtracks | Traps Triggered | Power-Ups Used | Max Stack Depth");
        log.append("Agent | Moves | Backtracks | Traps Triggered | Power-Ups Used | Max Stack Depth\n");
        System.out.println("------|-------|------------|-----------------|----------------|-----------------");
        log.append("------|-------|------------|-----------------|----------------|-----------------\n");
        for (int i = 0; i < agents.size(); i++) {
            Agent agent = agents.get(i);
