    ...
    public void applyEffect(Agent a) {
        switch (type) {
            ...
            case 'G':
                ...
                // Clear agent from both old and new positions
                maze.updateAgentLocation(a, x, y);
                hasAgent = false;
                break;
        }
    }
    ...
    public String toString() {
        if (hasAgent) {
            ...
            for (int i = 0; i < agents.size(); i++) {
                ...
                if (a != null && a.getCurrentX() == x && a.getCurrentY() == y && !a.isFinished()) {
                    return "A" + a.getId();
                }
            }
            // Automatically clear stale agent markers
            hasAgent = false;
        }
